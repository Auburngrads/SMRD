SMRDOptionsDefaults <-
  function ()
  {
    return(list(SMRD.ConfLevel = 95, SMRD.DigitsPrinted = 4,
                ...
                SMRD.DateOnPlot = FALSE, SMRD.NameOnPlot = "", SMRD.LabelOnYaxis = "Fraction Failing",
                SMRDResponseOnXaxis = FALSE, SMRD.LongPrint = TRUE,
                ...
                SMRD.TitleOption = "blank", SMRD.DataCheck = "strong",
                SMRD.Randomize = "stream", SMRD.DebugLevel = "off",
                SMRD.QuantileFocus = ".1", SMRD.solid.lines = TRUE,
                SMRD.point.size = 100, SMRD.long.names = TRUE, SMRD.NumberTicks = 4,
                SMRD.PrintSummary = TRUE, SMRD.likelihood.method = "smoothed",
                SMRD.ClassCoding = "contr.treatment", SMRD.WarnMaskedObjects = TRUE,
