...
tabPanel("Data Set", DT::dataTableOutput("heatexchanger", height = "575px")),
                
tabPanel("Figure 1.6", titlePanel("Edit this code and press 'Evaluate' to change the figure"),
  sidebarLayout( 
...
arrows(x0 = rep(345,3),
       ...
       x1 = rep(350,3),
       length=rep(0.1,3))"),
              actionButton("evalfig6", "Evaluate")),
        
        mainPanel(plotOutput("plotfig6"), width = 7))),
                
tabPanel("Figure 1.7", titlePanel("Edit this code and press 'Evaluate' to change the figure"),
  sidebarLayout( 
    sidebarPanel(width = 5,
...
arrows(x0 = rep(345,3),
       ...
       x1 = rep(350,3),
       length=rep(0.1,3))"),
              actionButton("evalfig7", "Evaluate")),
        
        mainPanel(plotOutput("plotfig7"), width = 7))))
