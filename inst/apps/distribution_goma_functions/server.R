...
goma.C <-  reactive({ SMRD::pgoma(goma.t(), input$th.goma, input$ze.goma, input$et.goma)})
goma.P <-  reactive({ SMRD::dgoma(goma.t(), input$th.goma, input$ze.goma, input$et.goma)})
goma.R <-  reactive({ 1-goma.C()})
goma.h <-  reactive({ exp(log(goma.P())-log(goma.R()))})
goma.H <-  reactive({-1*log(1-SMRD::pgoma(goma.t(), input$th.goma,input$ze.goma,input$et.goma))})
goma.Q <-  reactive({ SMRD::qgoma(goma.p(), input$th.goma,input$ze.goma,input$et.goma)})
