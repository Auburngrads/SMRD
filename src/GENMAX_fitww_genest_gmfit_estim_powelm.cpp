...
//    dd=0.7d00*dd;
      ...
      if(debug::kprint >= 3) {
         ...
         Rcpp::warning("powelm: dd changing sign");
...
line18: if(debug::kprint >= 2){
           ...
           Rcpp::warning("powelm: maximum change does not alter function");
...
line108: iterc = iterc + 1;
        ...
        Rcpp::warning("powelm: %i iterations completed without meeting specifications", maxit);
...
line993: ier = 3;
         Rcpp::warning("powelm terminating because of too many restarts");
