...
double area,area1 = 0,area12,area2 = 0,a1;
double defabs = 0, ertest = 0, resabs = 0, erlarg = 0;
double defab1 = 0, abseps = 0, defab2 = 0;
double error1 = 0, error2 = 0, reseps = 0;
double a2,b1,b2,correc;
double dres,epmach,erlast,errbnd,errmax;
double erro12,errsum,oflow;
double small = 0.0e00,uflow;
...
//   and error and test for accuracy.
        ...
        if((std::abs(work.at((l2 - 1) + maxerr - 1) - area12) > (0.1e-04 * std::abs(area12))) or (erro12 < (0.99e+00 * errmax))) goto line10;
...
//    smallest interval.
      ...
      if((ierro == 3) or (erlarg <= ertest)) goto line60;
