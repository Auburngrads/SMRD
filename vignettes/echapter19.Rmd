...
DeviceA.lognor.groupm <- groupm.mleprobplot(DeviceA.ld, 
                                            distribution = "Lognormal", 
                                            relationship = "Arrhenius")
...
DeviceA.groupm.mleprobplot <- groupm.mleprobplot(DeviceA.ld, 
                                                 distribution = "Lognormal", 
                                                 relationship = "Arrhenius",
                                                 ci.list = 1)
...
mylarpoly.lognor.groupi <- groupi.mleprobplot(mylarpoly.ld, 
                                              distribution = "Lognormal")
...
mylarsub.lognor.groupm <- groupm.mleprobplot(mylarsub.ld,  
                                             distribution = "Lognormal", 
                                             relationship = c("log"), 
                                             new.data = 50)
...
mylarpoly.lognor.groupm <- groupm.mleprobplot(mylarpoly.ld, 
                                              distribution = "Lognormal", 
                                              relationship = "class")
...
ICDevice2.groupm.lognor.ea <- groupm.mleprobplot(ICDevice2.ld, 
                                                 distribution = "Lognormal",
                                                 relationship = "Arrhenius", 
                                                 ci.list = 6, 
                                                 new.data = 100,
...
quantiles(ICDevice02.groupm.lognor.ea.8,
          new.data = 100,
          to = 0.2)

failure.probabilities(ICDevice02.groupm.lognor.ea.8, 
                      new.data = 100,
                      time.vec = c(500,1000))

plot(ICDevice02.groupm.lognor.ea.8, 
     censor.time = 2304,
     quant.lines = c(.01,0.1, .5))
```
...
groupi.Tantalum <- groupi.mleprobplot(Tantalum.ld, 
                                      distribution = "Weibull", 
                                      group = c(1, 2))

summary(groupi.Tantalum)

Tantalum.groupm.weib <- groupm.mleprobplot(Tantalum.ld, 
                                           group.var = c(1,2),
                                           distribution = "Weibull",
...
classh.turn.groupi <- groupi.mleprobplot(classh.turn.ld, 
                                         distribution = "Lognormal")

summary(classh.turn.groupi)

classh.turn.groupm <- groupm.mleprobplot(classh.turn.ld, 
                                         distribution = "Lognormal", 
                                         relationship = "Arrhenius")
...
classh.ground.groupi <- groupi.mleprobplot(classh.ground.ld, 
                                           distribution = "Lognormal")

summary(classh.ground.groupi)

classh.ground.groupm <- groupm.mleprobplot(classh.ground.ld, 
                                           distribution = "Lognormal",
                                           relationship = "Arrhenius")
...
classh.phase.groupi <- groupi.mleprobplot(classh.phase.ld, 
                                          distribution = "Lognormal")
summary(classh.phase.groupi)

classh.phase.groupm <- groupm.mleprobplot(classh.phase.ld,
                                          distribution = "Lognormal", 
                                          relationship = "Arrhenius")
...
AlloyZ.groupm <- groupm.mleprobplot(AlloyZ.ld,
                                    distribution = "Weibull",
                                    relationship = "Log")
