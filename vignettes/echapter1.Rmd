...
subtitle: "`r SMRD2:::info('chapter1')`"
...
- Many functions in the SMRD2 package require a `life.data` object.  `life.data` objects are created using the function `frame.to.ld`.
