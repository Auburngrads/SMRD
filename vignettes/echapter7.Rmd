...
subtitle: "`r SMRD2:::info('chapter7')`"
...
```{r}
berkson200.mle.exp <- SMRD2:::mlest(berkson200.ld, distribution = "Exponential")
...
```{r}
SMRD2:::mleprobplot(berkson200.ld, 
...
```{r}
SMRD2:::simple.contour(berkson200.ld, 
               distribution = 'exponential', 
               xlim = c(400,800))
```
