...
SMRD2:::plot.marginals.sim(InsulationBrkdwn.plan.sim.out,
...
SMRD2:::plot.joint.sim(InsulationBrkdwn.plan.sim.out, 
...
SMRD2:::plot.joint.and.marginals.sim(InsulationBrkdwn.plan.sim.out, 
                                     focus.quantity1 = "quantile",
                                     focus.quantity.detail1 = 0.1,
                                     x.of.interest1 = "150",
                                     focus.quantity2 = "parameter",
