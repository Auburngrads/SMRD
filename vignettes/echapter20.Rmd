...
```{r}
DeviceR.altplan <- get.alt.test.plan.direct(accel.variable.levels = cbind(c(80,80,120,120),c(50,80,50,80)),
...
DeviceR.sim.out <- simulate.ALT.test.plan(DeviceR.altplan, 
                                          DeviceR.Weibull.altpv, number.sim = 400,
                                          show.detail.on = 5)
