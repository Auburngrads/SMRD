...
Issues with this code chunk don't know where the function `f.phibf` is.
...
SMRD2:::profile.plot(Fr.profile(fcn <- function(x){x[1]},
...
SMRD2:::profile.plot(LaminatePanel.fit22.outstruct3)
...
SMRD2:::profile.plot(hcf22.fitstruct3)
