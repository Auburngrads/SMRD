...
subtitle: "`r SMRD2:::info('chapter6')`"
...
Bleed.ld_D <- SMRD2:::ld.split(Bleed.ld,stress.var="D")
Bleed.ld_Other <- SMRD2:::ld.split(Bleed.ld,stress.var="Other")
```
