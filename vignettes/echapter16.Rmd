...
SMRD:::TestWindow(amsaaexactfail[[1]],
           amsaaexactfail[[2]],
           amsaaexactfail[[3]],
           NULL)
...
theta.mat <- c(1,2)
SMRD:::loglikeNHPPvec(AMSAAExactFail.rdu, theta.mat, "power.law")
SMRD:::TestLike(AMSAAExactFail.rdu, theta.mat, "power.law")

theta.mat <- matrix(c(.01,.01,.02,.02),2,2)
SMRD:::loglikeNHPPvec(AMSAAExactFail.rdu, theta.mat, "log.linear")
...
SMRD:::get.UnitID(AMSAAExactFail.rdu)
