...
//
{
  ...
  if ( i == 1 ) value = 1.450147717014403E-308;
  
  if ( i == 2 ) value = 1.450147717014403E+307;
  
  if ( i == 3 ) value = 1.110223024625157E-016;
  
  if ( i == 4 ) value = 2.220446049250313E-016;
  
  if ( i == 5 ) value = 0.301029995663981E+000;
